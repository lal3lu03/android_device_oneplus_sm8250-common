...
INSTANTNOODLEP_AVB_KEY_PATH ?= vendor/lineage-priv/keys/release/avb.pem
ifneq ($(wildcard $(INSTANTNOODLEP_AVB_KEY_PATH)),)
BOARD_AVB_VBMETA_SYSTEM_KEY_PATH := $(INSTANTNOODLEP_AVB_KEY_PATH)
else
